...
public class RestaurantM4N2App {
	...
	public static void main(String[] args) {
		...
		do {
			...
			try {
				...
				if (!existeixPlat) throw new Exception("El plat introduït no existeix");
				llistaPlats.add(platAfegir);		// Si existeix el plat, l'afegim a la List llistaPlats
				
			}
			
			catch (Exception exc) {		// Si no existeix el plat, mostrem missatge de que no està al menú
